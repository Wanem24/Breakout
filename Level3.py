...
#Screen Display------------------------------------------------------------------
LEVEL3 = Tk()
LEVEL3.title("BREAKOUT")
LEVEL3.resizable(0, 0)
canvas = Canvas(LEVEL3, bg="Black", width="1000", height="700")
canvas.pack()
LEVEL3.update()
#LEVEL--------------------------------------------------------------------------
Level = Label(LEVEL3, text="Current level: 3", bg="Black", fg="White", font=("Space Bd BT",15))
#LIFE POINTS
LP = Label(LEVEL3, text="Life points:", bg="Black", fg="White", font=("Space Bd BT",15))
#TIME----------------------------------------------------------------------------
Time = Label(LEVEL3, text="Time left:", bg="Black", fg="White", font=("Space Bd BT",15))
#LOGO#--------------------------------------------------------------------------------
Logo = Label(LEVEL3, text="BREAKOUT", bg="Black", fg="White", font=("Space Bd BT",40))
#PACKS#-------------------------------------------------------------------------------
...
Brick_Left = 50 #Number of bricks in the beginning
Time = 170 #Time
        ...
        if pos[2] >= paddle_pos[0] and pos[0] <= paddle_pos[2]:
            if pos[3] >= paddle_pos[1] and pos[3] <= paddle_pos[3]:
                ...
                if Time == 0:
                    ...
                    LEVEL3.after(3000, lambda: LEVEL3.destroy())
...
class Paddle:
    def __init__(self, canvas):
        ...
        self.id = canvas.create_rectangle(200, 700, 410, 386, fill="red")
