...
#Screen Display------------------------------------------------------------------
LEVEL1 = Tk()
LEVEL1.title("BREAKOUT")
LEVEL1.resizable(0, 0)
canvas = Canvas(LEVEL1, bg="Black", width="1000", height="700")
canvas.pack()
LEVEL1.update()
#LEVEL--------------------------------------------------------------------------
Level = Label(LEVEL1, text="Current level: 1", bg="Black", fg="White", font=("Space Bd BT",15))
#LIFE POINTS
LP = Label(LEVEL1, text="Life points:", bg="Black", fg="White", font=("Space Bd BT",15))
#TIME----------------------------------------------------------------------------
Time = Label(LEVEL1, text="Time left:", bg="Black", fg="White", font=("Space Bd BT",15))
#LOGO#--------------------------------------------------------------------------------
Logo = Label(LEVEL1, text="BREAKOUT", bg="Black", fg="White", font=("Space Bd BT",40))
#PACKS#-------------------------------------------------------------------------------
...
Brick_Left = 30 #Number of bricks in the beginning
Time = 170 #Time
        ...
        if pos[2] >= paddle_pos[0] and pos[0] <= paddle_pos[2]:
            if pos[3] >= paddle_pos[1] and pos[3] <= paddle_pos[3]:
                ...
                if Time == 0:
                    ...
                    LEVEL1.after(3000, lambda: LEVEL1.destroy())
...
class Paddle:
    def __init__(self, canvas):
        ...
        self.id = canvas.create_rectangle(200, 700, 450, 386, fill="red")
...
class Brick8:
    def __init__(self):
        self.id = canvas.create_rectangle(700, 120, 800, 150, fill="White")
    def draw(self):
        pass

class Brick9:
    def __init__(self):
        self.id = canvas.create_rectangle(800, 120, 900, 150, fill="Red")
    def draw(self):
        pass
...
class Brick11:
    def __init__(self):
        self.id = canvas.create_rectangle(0, 150, 100, 180, fill="Red") 
    def draw(self):
        pass

class Brick12:
    def __init__(self):
        self.id = canvas.create_rectangle(100, 150, 200, 180, fill="Blue") 
    def draw(self):
        pass

class Brick13:
    def __init__(self):
        self.id = canvas.create_rectangle(200, 150, 300, 180, fill="Red") 
    def draw(self):
        pass

class Brick14:
    def __init__(self):
        self.id = canvas.create_rectangle(300, 150, 400, 180, fill="Blue") 
    def draw(self):
        pass

class Brick15:
    def __init__(self):
        self.id = canvas.create_rectangle(400, 150, 500, 180, fill="Blue") 
    def draw(self):
        pass
...
class Brick18:
    def __init__(self):
        self.id = canvas.create_rectangle(700, 150, 800, 180, fill="Blue") 
    def draw(self):
        pass

class Brick19:
    def __init__(self):
        self.id = canvas.create_rectangle(800, 150, 900, 180, fill="Blue") 
    def draw(self):
        pass
...
class Brick21:
    def __init__(self):
        self.id = canvas.create_rectangle(0, 180, 100, 210, fill="Red") 
    def draw(self):
        pass

class Brick22:
    def __init__(self):
        self.id = canvas.create_rectangle(100, 180, 200, 210, fill="Blue") 
    def draw(self):
        pass

class Brick23:
    def __init__(self):
        self.id = canvas.create_rectangle(200, 180, 300, 210, fill="Blue") 
    def draw(self):
        pass

class Brick24:
    def __init__(self):
        self.id = canvas.create_rectangle(300, 180, 400, 210, fill="White") 
    def draw(self):
        pass

class Brick25:
    def __init__(self):
        self.id = canvas.create_rectangle(400, 180, 500, 210, fill="White") 
    def draw(self):
        pass

class Brick26:
    def __init__(self):
        self.id = canvas.create_rectangle(500, 180, 600, 210, fill="Blue") 
    def draw(self):
        pass

class Brick27:
    def __init__(self):
        self.id = canvas.create_rectangle(600, 180, 700, 210, fill="Blue") 
    def draw(self):
        pass

class Brick28:
    def __init__(self):
        self.id = canvas.create_rectangle(700, 180, 800, 210, fill="White") 
    def draw(self):
        pass
...
class Brick30:
    def __init__(self):
        self.id = canvas.create_rectangle(900, 180, 1000, 210, fill="Red") 
    def draw(self):
        pass
